{
  ...
  inputs = {
    ...
    niri-flake.inputs.niri-unstable.url = "github:daphen/niri/5555a4dae4aa22b81c4da2a24515cbaa68577af9";
  ...
  outputs = { self, nixpkgs, nixpkgs-iwd, nixpkgs-apps, nixpkgs-neovim, home-manager, niri-flake, worktrunk, palette-daemon, ... }@inputs:
    let
      ...
      applicationPkgs = import nixpkgs {
        inherit system;
        config.allowUnfree = true;
        overlays = [ appsOverlay neovimOverlay inputs.quickshell.overlays.default ];
      };
